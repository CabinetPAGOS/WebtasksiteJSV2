...
// GESTION DES ACCÈs
// Mémoriser la position de défilement avant soumission du formulaire
...
function restoreScrollPosition() {
    ...
    if (scrollPosition !== null) {
        ...
        sessionStorage.removeItem('scrollPosition'); // Supprimer la position après restauration
    }
}

// Restaurer la position de défilement quand la page est chargée
