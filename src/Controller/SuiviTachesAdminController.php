...
class SuiviTachesAdminController extends AbstractController
{
    ...
    #[Route('/admin/suivitaches/{id}', name: 'app_suivitachesadmin')]
    public function suivitachesadmin(Request $request, $id): Response       
    {
        ...
        return $this->render('Admin/suivitaches.html.twig', [
            'webtask' => $webtask,
            'mappedTag' => $mappedTag,
            'tagClass' => $tagClass,
