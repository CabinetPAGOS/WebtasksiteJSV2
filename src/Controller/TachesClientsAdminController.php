...
class TachesClientsAdminController extends AbstractController
{
    ...
    #[Route('/admin/tachesclients/{clientId}', name: 'app_tachesclientsadmin')]
    ...
    {
        // Le clientId est maintenant récupéré de l'URL
