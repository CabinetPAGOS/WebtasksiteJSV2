...
// src/Controller/TachesClientsController.php
...
class TachesClientsController extends AbstractController
{
    ...
    #[Route('/client/tachesclients/{clientId}', name: 'app_tachesclients')]
    public function tachesclientsadmin($clientId, Request $request, WebtaskRepository $webtaskRepository, NotificationRepository $notificationRepository): Response
    {
        ...
        // Récupérer le client spécifié par l'ID dans l'URL
        ...
        foreach ($webtasksON as $webtask) {
            ...
            if ($piloteId) {
                ...
                if (!isset($pilotes[$piloteKey])) {
                    ...
                    $pilotes[$piloteKey] = [
                        'prenom' => $piloteId->getPrenom(),
                        'initiale' => strtoupper(mb_substr($prenom, 0, 1)) . '.',
                        'nom' => strtoupper($nom)
